...
from proc import Tensor, Sequential, Conv2d, AvgPool2d, Tanh, Flatten, Linear, CrossEntropyLoss, Adam, no_grad
...
print("-" * 70)
print(f"\nОбщее время обучения: {total_duration:.2f} секунд")
print(f"Среднее время на одну эпоху: {total_duration/30:.2f} секунд")
